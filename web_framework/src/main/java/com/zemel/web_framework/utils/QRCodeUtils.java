...
public class QRCodeUtils {
    ...
    public static String encode0(String content,String destPath,String fileName) throws Exception {
        BufferedImage image = QRCodeUtils.createImage(content, destPath+"image.jpg",
                true);
        mkdirs(destPath);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String logoPath = "D:\\13265\\Pictures\\picture\\test.jpg";
        String destPath = "D:\\13265\\Pictures\\picture\\";
        System.out.println(QRCodeUtils.encode(text, logoPath, destPath, true,null));
    }
}